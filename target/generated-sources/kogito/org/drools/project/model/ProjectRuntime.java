...
public class ProjectRuntime implements KieRuntimeBuilder {
    ...
    private static java.util.Map<String, KieBase> initKieBases() {
        ...
        if (org.kie.kogito.internal.RuntimeEnvironment.isNative()) {
            kbaseMap.put("defaultKieBase", new KieBaseImpl(KieBaseBuilder.createKieBaseFromModel(model.getModelsForKieBase("defaultKieBase"), model.getKieModuleModel().getKieBaseModels().get("defaultKieBase"))));
        }
        return kbaseMap;
    }
